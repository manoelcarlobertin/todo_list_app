...
class TaskItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_item" do
    assert_difference("TaskItem.count") do
      post task_items_url, params: { task_item: { description: @task_item.description, done: @task_item.done, task_list_id: @task_item.task_list_id } }
    end
  ...
  test "should update task_item" do
    patch task_item_url(@task_item), params: { task_item: { description: @task_item.description, done: @task_item.done, task_list_id: @task_item.task_list_id } }
